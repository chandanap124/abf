                        ...
                        <div className="header-left">
                            ...
                            <div className="dropdown for-message">
                                ...
                                <div className="dropdown-menu" aria-labelledby="message">
                                    ...
                                    <a className="dropdown-item media bg-flat-color-1" href="#">
                                        <span className="photo media-left"><img alt="avatar" src="images/avatar/1.jpg"></img></span>
                                    ...
                                    <a className="dropdown-item media bg-flat-color-4" href="#">
                                        <span className="photo media-left"><img alt="avatar" src="images/avatar/2.jpg"></img></span>
                                        <span className="message media-body">
                                    ...
                                    <a className="dropdown-item media bg-flat-color-5" href="#">
                                        <span className="photo media-left"><img alt="avatar" src="images/avatar/3.jpg"></img></span>
                                        <span className="message media-body">
                                    ...
                                    <a className="dropdown-item media bg-flat-color-3" href="#">
                                        <span className="photo media-left"><img alt="avatar" src="images/avatar/4.jpg"></img></span>
                                        <span className="message media-body">
