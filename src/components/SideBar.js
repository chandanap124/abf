            ...
            <aside id="left-panel" className="left-panel">
                <nav className="navbar navbar-expand-sm navbar-default">
                    ...
                    <div className="navbar-header">
                        ...
                        <a className="navbar-brand" href="./"><img src="images/logo.png" alt="Logo" ></img></a>
                        <a className="navbar-brand hidden" href="./"><img src="images/logo2.png" alt="Logo"></img></a>
                    </div>
                        ...
                        <ul className="nav navbar-nav">
                            ...
                            <li className="menu-item-has-children dropdown">
                                ...
                                <ul className="sub-menu children dropdown-menu">
                                    ...
                                    <li><i className="fa fa-spinner"></i><a href="ui-progressbar.html">Progress Bars</a>
                                    </li>
                                    ...
                                    <li><i className="fa fa-file-word-o"></i><a href="ui-typgraphy.html">Typography</a>
                                    </li>
                                </ul>
                            </li>
                            <li className="menu-item-has-children dropdown">
                            ...
                            <li className="menu-item-has-children dropdown">
                                ...
                                <ul className="sub-menu children dropdown-menu">
                                    <li><i className="menu-icon fa fa-th"></i><a href="forms-basic.html">Basic Form</a>
                                    </li>
                            ...
                            <li className="menu-item-has-children dropdown">
                                ...
                                <ul className="sub-menu children dropdown-menu">
                                    <li><i className="menu-icon fa fa-fort-awesome"></i><a href="font-fontawesome.html">Font
                                        Awesome</a></li>
                            ...
                            <li className="menu-item-has-children dropdown">
                                ...
                                <ul className="sub-menu children dropdown-menu">
                                    <li><i className="menu-icon fa fa-sign-in"></i><a href="page-login.html">Login</a>
                                    </li>
